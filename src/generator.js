 ...
 * @param {String} [options.separator='_'] - separator between the prefix and random chars
 * @param {String} [options.marketplaceId] - DEPRECATED: remove this after renaming marketplace into platform
 ...
 * @param {String} [options.marketplaceZone] - DEPRECATED: remove this after renaming marketplace into platform
 * @return {String}
 */
async function getObjectId ({
  ...
  if (marketplaceId && !platformId) {
    platformId = marketplaceId
  }
  if (marketplaceZone && platformZone === platformZones[0]) {
    platformZone = marketplaceZone
  }
  // DEPRECATED:END
...
function extractDataFromObjectId (objectId) {
  ...
  return {
    object,
    platformId,
    marketplaceId: platformId, // DEPRECATED: remove this after renaming marketplace into platform
    zone,
    isLive,
    timestamp
  }
...
module.exports = {
  ...
  marketplaceZones: platformZones // remove this after renaming marketplace into platform
}
